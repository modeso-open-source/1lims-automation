elements = {
    ...
    'order': {
        ...
        'testplan_popup_btn': {'method': 'tag_name',
                               'value': 'i',
                               'order': 0},
        'testplan_pop_up_cancel_btn': {'method': 'xpath',
                                       'value': "//div[@id='infoModalTable']//button[@class='btn btn-default mb-md-0 mr-md-3'][contains(text(),'Cancel')]"},
        'testplan_pop_up_close_btn': {'method': 'xpath',
                                      'value': "//div[@id='infoModalTable']//button[@class='close'][contains(text(),'×')]"},
