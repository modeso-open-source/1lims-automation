elements = {
    ...
    'orders': {
        ...
        'created_on_filter': {'method': 'xpath',
                              'value': "//div[@class='col-lg-4 ng-star-inserted']//input[@id='start_createdAt']"},
        'created_on_filter_end': {'method': 'xpath',
                                  'value': "//div[@class='col-lg-4 ng-star-inserted']//input[@id='end_createdAt']"},
        'test_date_filter': {'method': 'id',
                             'value': 'start_testDate'},
        'test_date_filter_end': {'method': 'id', 'value': 'end_testDate'},
        'shipment_date_filter_end': {'method': 'xpath',
                                     'value': "//div[@class='col-lg-4 ng-star-inserted']//input[@id='end_shipmentDate']"},
        'shipment_date_filter': {'method': 'xpath',
                                 'value': "//div[@class='col-lg-4 ng-star-inserted']//input[@id='start_shipmentDate']"},
        'analysis_tab': {
            'method': 'xpath',
            'value': "//label[@class='btn tab']"},
