...
class OrdersTestCases(BaseTest):
    ...
    def test042_duplicate_main_order_with_testPlans_and_testUnits(self):
        ...
        test_units.append(TestPlanAPI().get_testunits_in_testplan_by_No(payload[0]['testPlans'][0]['number']))
        test_units.append(TestPlanAPI().get_testunits_in_testplan_by_No(payload[0]['testPlans'][1]['number']))
